...
;          February 2026, Massa P., removed transmission correction to raw counts as not needed
;
; CONTACT:
;   paolo.massa@fhnw.ch
;-
...
;  ;; Correct 10a bot
;  idx_10a = stx_label2ind('10a')
;  counts[*,4,idx_10a,*] = counts[*,0,idx_10a,*]
;  counts_error[*,4,idx_10a,*] = counts_error[*,0,idx_10a,*]
